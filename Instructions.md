...
- Your login: is mfwsuser21@demo.broadcom.com
...
- Your userid is CUST021.
- Your password CUST021.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS21 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS21 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST021.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST021.MARBLES.JCL(MARBCOPY)" --vasc`
...
Username: _JENKINSCUST021
Password: Mfuser21@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-21.git`
